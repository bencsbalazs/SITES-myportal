...
@Component({
  ...
  styles: ['.card{background:rgba(255,255,255,0.8);}.card,.card>.fa,.card>div,.card>h3{transition:linear 1s}.card{transform:scale(.95);border:0 solid #fff}.card>.fa{transform:scale(2)}.card>div,.card>h3{transform:scale(.8);text-align:center}.card:hover>div,.card:hover>h3{transform:scale(1)}.card:hover{transform:scale(1.1);z-index:999;border:.2em solid #000;box-shadow:0 0 .8em #fff}.card:hover>.fa{transform:scale(.6)}']
})
