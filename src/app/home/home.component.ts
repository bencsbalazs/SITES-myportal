...
@Component({
  ...
  <section class="my-5 py-5 wow fadeIn bg-grey" id="partners"><app-home-partners></app-home-partners></section>
  <section class="my-5 py-5 wow fadeIn" id="contactme"><app-home-contactme></app-home-contactme></section>
`,
  styles: ['']
})
