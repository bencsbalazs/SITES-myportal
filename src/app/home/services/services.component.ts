...
@Component({
  ...
  styles: ['.card{transition: ease-in-out 500;}.card:hover{box-shadow: 0 0 1em #ccc inset, 0 0 1em #000;z-index:999;}.card:nth-child(odd):hover{transform: rotate(10deg);}.card:nth-child(even):hover{transform: rotate(-10deg);}']
})
